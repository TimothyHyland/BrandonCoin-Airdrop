    ...
    try {
      ...
      setClaimMessage({
        ...
        payload: `
          ...
          Total Amount: ${Web3.utils.fromWei(response.data.totalAllocation.toString())} BrandonCoin
          -> Basic allocation: ${Web3.utils.fromWei(response.data.basicAllocation.toString())} BrandonCoin
      ...
      const receipt = await airdrop
        ...
        .send({from: accounts[0],gas: 497407});
      setClaimMessage({
        type: 'primary',
...
Reason" Airdrop already sent to ${address}`
  ...
  return (
    <div className='container'>
      <Head>
        <title>BrandonCoin Airdrop</title>
      ...
      <div className='row mt-4'>
        <div className='col-sm-12'>
          <div className="jumbotron">
            <h1 className='text-center'>BrandonCoin Airdrop</h1>
          </div>
        </div>
      </div>
            ...
            <div className="card-body">
              ...
              <div className="card-text">
                <ul>
                  ...
                  <li>Step 3: Enter your BSC address and click on submit. This will fetch an authorization signature from the list of whitelisted addresses From BrandonCoin Discord</li>
                  <li>Step 4: Confirm the transaction to claim your BCC tokens. This will send a transaction to the Airdrop smart contract</li>
                </ul>
              </div>
            </div>
          </div>
